...
b4_locations_if([, ref ]b4_location_type[ yylocationp])[)
  ...
  public bool parse ()
  {
    ...
    /// previous invocation.
    yy_lac_discard("init");]])[]b4_parse_trace_if([[
  ...
  [  /* Initialize the stack.  */
    ...
    for (;;)
      ...
      case YYNEWSTATE:]b4_parse_trace_if([[
        ...
        else
        {
          ...
          else if ((yyn = yytable_[yyn]) <= 0)
          {
            ...
            else if (!yy_lac_establish(yytoken))
              label = YYERRLAB;]])[
            else
            {
              yyn = -yyn;
      ...
      case YYERRLAB1:
        ...
        yy_lac_discard("error recovery");]])[]b4_parse_trace_if([[
        import std.conv : to;
    ...
    for (int yyx = 0; yyx < yyntokens_; ++yyx)
      {
        ...
        if (yysym != ]b4_symbol(1, kind)[
            ...
            && yy_lac_check(yysym))
          {
            if (!yyarg) // aici probabil o sa fie o problema
              ++yycount;
